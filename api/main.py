...
@app.get("/trade-values/rmt", tags=["trade-values"],responses={200: {"description": "OK"}},
...
@app.get("/trade-values/poetrade", tags=["trade-values"],responses={200: {"description": "OK"}},
...
@app.get("/currency-purchase/detailed", tags=["currency-purchase"], responses={200: {"description": "OK"}},
...
@app.get("/currency-purchase/simple", tags=["currency-purchase"], responses={200: {"description": "OK"}},
